...
updates:
  - date: "2026-08-06"
    version: "v1.3.0"
    items:
      - "新ダッシュボードゲージテーマ「レーシング・カーボン」を追加 — 速度・傾斜・距離/高度タイルをメカニカルなゲージ表示に切り替え可能に"
      - "丸型メーター（速度）・水平器（傾斜）・ドラム式高度計（距離/高度）の3種類のゲージスタイルに対応（設定 > ダッシュボードゲージ、無料）"
  - date: "2026-07-10"
    version: "v1.2.1"
    items:
  ...
  - date: "2026-07-07"
    version: "v1.2.0"
    items:
      - "ライド中のテーマ自動切替、GPS表示、距離タイル非表示時の記録漏れなど複数の不具合を修正"
      - "カウントダウンタイマーの精度と、一時停止中の記録動作を改善"
      - "ライド中に誤って画面を閉じないよう保護機能を追加"
      - "表示の修正、広告・起動時の安定性を改善"
  - date: "2026-07-03"
    version: "v1.1.1"
    items:
